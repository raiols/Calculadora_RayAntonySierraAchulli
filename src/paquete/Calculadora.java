...
public class Calculadora extends javax.swing.JFrame {
    ...
    public Calculadora() {
        initComponents();
        this.setLocationRelativeTo(null);//para sentrar la ejecución en medio de la pantalla
    }
    ...
    private void initComponents() {
        ...
        casilla.setFont(new java.awt.Font("Dubai Medium", 1, 18)); // NOI18N
        casilla.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        casilla.setBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(51, 51, 51), new java.awt.Color(51, 51, 51)));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        this.casilla.setText("");//para poner el C clear "limpiador" en blanco borrar
